...
// import { set } from '@/redux/jobSlice';
...
//   const isInitiallyApplied = ?.applications?.some(application => application.applicant === authUser?._id) || false;
...
//         const updatedJob = { ..., applications: [....applications, { applicant: authUser._id }] };
//         dispatch(set(updatedJob)); // Update the Redux state
  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      ...
      <div>
        ...
        <h1 className='font-bold my-1'>Experience: <span className='pl-4 font-normal text-gray-800'>experienceLevel</span></h1>
        <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>salaryLPA</span></h1>
        <h1 className='font-bold my-1'>Total Applicants: <span className='pl-4 font-normal text-gray-800'>applications</span></h1>
        <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>createdAt.split</span></h1>
      </div>
      <div>
